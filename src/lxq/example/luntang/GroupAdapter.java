...
public class GroupAdapter extends BaseAdapter{  
    ...
    public View getView(int position, View convertView, ViewGroup parent) {  
        ...
        if(convertView == null){  
            ...
            convertView = mInflater.inflate(R.layout.fragment_gridview_item_linxingqiang, null);  
            viewHolder.mImageView = (MyImageView) convertView.findViewById(R.id.fragment_gridview_item_group_image);  
            viewHolder.mTextViewTitle = (TextView) convertView.findViewById(R.id.fragment_gridview_item_group_title);  
            viewHolder.mTextViewCounts = (TextView) convertView.findViewById(R.id.fragment_gridview_item_group_count);  
